# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-10-17 01:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.CharField(choices=[('A', 'Aberta'), ('F', 'Fechada'), ('B', 'Bloqueada pela Contabildade')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codigo_conta', models.CharField(max_length=9, unique=True, validators=[
                    django.core.validators.RegexValidator('^[0-9]*$',
                                                          'Apenas valores numéricos, de 0 até 9, são permitidos.')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('municipio', models.ForeignKey(default=2927408, on_delete=django.db.models.deletion.CASCADE,
                                                to='glb.GlobalMunicipio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('valor', models.DecimalField(decimal_places=2, default=0.0, max_digits=16, max_length=16,
                                              validators=[ctb.models.validate_valor_minimo])),
                ('d_c', models.CharField(choices=[('D', 'Débito'), ('C', 'Crédito')], default='D', max_length=1)),
                ('historico', models.TextField(max_length=200)),
                ('codigo_participante', models.CharField(blank=True, default='', max_length=3, null=True)),
                ('tipo_documento', models.CharField(blank=True, default='', max_length=3, null=True)),
                ('numero_documento', models.CharField(blank=True, default='', max_length=10, null=True)),
                ('data_documento', models.DateField(blank=True, null=True)),
                (
                'codigo_historico', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ctb.Historico')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_competencia',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ctb.Competencia')),
                (
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE,
                                    related_name='periodos', to='ctb.MovimentoContabilHeader'),
        ),
        migrations.AddField(
            model_name='lancamentocontabil',
            name='header',
        ...
        migrations.AlterUniqueTogether(
            name='saldocontacontabil',
            unique_together=set([('data_competencia', 'conta')]),
        ),
        migrations.AlterUniqueTogether(
            name='conta',
